    ...
    <div id="sidebar">  
      <div id="sidebar_logging">                     
        ...
        <ul id="logs">
          ...
          <li><?php echo WPOTools::timezoneMysql('F j, g:i a', $log->created_on) . ' &mdash; <strong>' . esc_attr($log->message) ?></strong></li>
          <?php endforeach; ?>
        </ul>         
        <?php endif; ?>                                                                               
      ...
      <?php else: ?>
        <ol class="campaignlist">
          ...
          <li>
            ...
            <a href="<?php echo $this->adminurl ?>&amp;s=list&amp;id=<?php echo $campaign->id ?>"><?php echo esc_attr($campaign->title) ?></a></li>
          <?php endforeach; ?>  
        </ol>
      <?php endif; ?>
